        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderDeadlineUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tip = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountOwed = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_Participants_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_ParticipantId",
                table: "CartItems",
                column: "ParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_SessionId",
                table: "MenuItems",
                column: "SessionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Receipts_OrderId_ParticipantId",
                table: "Receipts",
